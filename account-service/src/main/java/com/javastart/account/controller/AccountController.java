...
public class AccountController {
    ...
    public AccountRequestDTO updateAccount(@PathVariable Long accountId,
                                           @RequestBody AccountRequestDTO accountRequestDTO) {
        return new AccountRequestDTO(accountService.updateAccount(
                accountId,
                accountRequestDTO.getName(),
                accountRequestDTO.getEmail(),
                accountRequestDTO.getPhone(),
    ...
    public AccountRequestDTO deleteAccount(@PathVariable Long accountId) {
        return new AccountRequestDTO(accountService.deleteAccount(accountId));
    }
}
